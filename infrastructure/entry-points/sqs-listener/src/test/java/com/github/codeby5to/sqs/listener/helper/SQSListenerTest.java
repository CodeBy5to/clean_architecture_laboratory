...
public class SQSListenerTest {
    ...
    @Test
    void listenerTest() {
        com.github.codeby5to.sqs.listener.config.SQSProperties sqsProperties = new SQSProperties();
